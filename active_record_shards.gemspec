Gem::Specification.new "active_record_shards", "3.2.1" do |s|
  ...
  s.add_runtime_dependency("activerecord", ">= 3.2.16", "< 4.2")
  s.add_runtime_dependency("activesupport", ">= 3.2.16", "< 4.2")
